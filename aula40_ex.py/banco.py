...
class Banco:
    ...
    def _chaca_conta(self, conta):
        if conta in self.contas:
            print('_checa_contas', True)
            return True
        print('_checa_contas', False)
        return False
    ...
    def autenticar(self, cliente: pessoa.Pessoa, conta: contas.Contas):
        return self._checa_agencia(conta) and \
            self._checa_cliente(cliente) and \
            self._chaca_conta(conta) and \
